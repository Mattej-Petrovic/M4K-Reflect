...
const kursmål = [
  ...
  },
  {
    ...
    body: 'Vår stack körde på GKE med namespace-isolering, Terraform-hanterad infrastruktur och Ingress med valfri TLS. Vi använde en återanvändbar Terraform-modul för deployments med inbyggda probes, resource limits och security context. Remote state i GCS, variabler med validering, och import-flöde för befintliga resurser. Under Terraform-migreringen (vecka 7) blev det tydligt hur arkitekturen hängde ihop, varje komponent (Redis, API, frontend, monitor, ingress) hade sitt eget ansvarsområde men behövde konfigureras rätt mot de andra. Bedömningen av arkitekturen handlade i praktiken om att förstå beroendena och se till att varje del gick att ändra utan att resten föll.',
  },
  {
    id: 11,
